            ...
            <div class="panel-body">
              <form class="form-horizontal adminex-form" id="contract-form" method="post" action="/customer/submitData" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="realName"  value="" class="form-control" required placeholder="请填写客户真实姓名!">
                  </div>
                </div>
                <!--客户性别 -->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                       <input type="text" name="birth"  required value="" class="form-control default-date-picker" placeholder="请输入客户出生日期">
                    </div>
                 </div>
                  <!--客户邮箱 -->
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="email"  value="" class="form-control" required placeholder="请填写客户邮箱!">
                  </div>
                </div>
                 <!--客户微信 -->
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="wechat"  value="" class="form-control" required placeholder="请填写客户微信!">
                  </div>
                </div>
                <!--客户qq -->
                <div class="form-group">
